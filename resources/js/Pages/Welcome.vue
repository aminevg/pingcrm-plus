    ...
    >
        ...
        >
            <Link
                ...
                class="text-sm text-slate-700 dark:text-slate-500 underline"
                >Dashboard</Link
            >
            ...
            <template v-else>
                ...
                <Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="ml-4 text-sm text-slate-700 dark:text-slate-500 underline"
                    >Register</Link
                >
            </template>
        </div>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg
                    ...
                    class="h-16 w-auto text-slate-700 sm:h-20"
                >
            ...
            <div
                class="mt-8 bg-white dark:bg-slate-800 overflow-hidden shadow sm:rounded-lg"
            >
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div
                        class="p-6 border-t border-slate-200 dark:border-slate-700 md:border-t-0 md:border-l"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                    ...
                    <div
                        class="p-6 border-t border-slate-200 dark:border-slate-700"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                    ...
                    <div
                        class="p-6 border-t border-slate-200 dark:border-slate-700 md:border-l"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <div
                                class="ml-4 text-lg leading-7 font-semibold text-slate-900 dark:text-white"
                            >
                                Vibrant Ecosystem
                            </div>
                        </div>
            ...
            >
                <div class="text-center text-sm text-slate-500 sm:text-left">
                    <div class="flex items-center">
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            class="-mt-px w-5 h-5 text-slate-400"
                        >
                            <path
                        ...
                        <svg
                            ...
                            stroke-width="2"
                            viewBox="0 0 24 24"
                            class="ml-4 -mt-px w-5 h-5 text-slate-400"
                        >
                            <path
                ...
                <div
                    class="ml-4 text-center text-sm text-slate-500 sm:text-right sm:ml-0"
                >
